	...
	<div class="max-w-md w-full mx-4">
		...
		<div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
			...
			<div class="px-6 pt-5 pb-4 text-center" style="background: linear-gradient(135deg, rgba(102, 126, 234, 0.1) 0%, rgba(118, 75, 162, 0.1) 100%);">
				...
				<p class="text-sm text-gray-600">Acceso para Pacientes</p>
			</div>
			...
			<div class="px-6 py-4">
				<form onsubmit={handleSubmit} class="space-y-4">
					...
					<button
						type="submit"
						disabled={isLoading}
						class="w-full py-2.5 px-4 rounded-lg font-semibold text-white shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-xl transform hover:-translate-y-0.5"
			...
			<!-- Footer -->
			<div class="px-6 py-3 bg-gray-50 text-center space-y-1.5">
				<button
					type="button"
		...
		<div class="mt-4 text-center text-white text-sm">
			<p class="opacity-80">Tu información médica está protegida y es estrictamente confidencial</p>
