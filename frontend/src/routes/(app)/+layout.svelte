<script>
	...
	import { canAccessPacientes, canAccessEspecialistas, canAccessHistorias, isPaciente } from '$lib/utils/permissions.js';
	...
	// Navegación para Especialistas
	const especialistaNavigation = [
	...
	const pacienteNavigation = [
		{ name: 'Inicio', href: '/', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6', requiresPermission: null },
		{ name: 'Mi Perfil', href: '/paciente/perfil', icon: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', requiresPermission: null },
		{ name: 'Notas', href: '/paciente/notas', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z', requiresPermission: null },
		{ name: 'Cambiar Contraseña', href: '/paciente/cambiar-password', icon: 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z', requiresPermission: null }
	];

	// Seleccionar navegación según el rol del usuario
	const allNavigation = $derived(
		isPaciente(user.rol) ? pacienteNavigation : especialistaNavigation
	);
